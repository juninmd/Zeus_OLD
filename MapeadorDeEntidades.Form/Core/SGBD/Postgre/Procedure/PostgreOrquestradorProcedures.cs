...
{
    public class PostgreOrquestradorProcedures
    {
        public RequestMessage<string> Postgre(FolderBrowserDialog salvar)
        {
            try
            {
                ...
                foreach (var nomeTabela in ParamtersInput.NomeTabelas)
                {
                    ...
                    var instancia = new PostgreProcedure(nomeTabela, new PostgreTables().ListarAtributos(nomeTabela));
