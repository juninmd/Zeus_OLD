...
namespace Zeus.Linguagens.Java.Postgre.Procedure
{
    public class JavaPostgreProcedure : BasePostgreDAO
    {
        ...
        private StringBuilder Imports()
        {
            ...
            imports.Append($"import Postgre.jdbc.PostgreTypes;{N}{N}");
            return imports;
        }
        ...
        private StringBuilder GetById()
        {
            ...
            get.Append($"			AddParamter(new Parameter(\"ID\", PostgreTypes.NUMBER, ID));{N}{N}");
        ...
        private StringBuilder Delete()
        {
            ...
            get.Append($"			AddParamter(new Parameter(\"P_RESULT\", PostgreTypes.VARCHAR, null,\"OUT\"));{N}{N}");
            get.Append($"			AddParamter(new Parameter(\"P_ID\", PostgreTypes.NUMBER, ID));{N}{N}");
            get.Append($"			return RequestProc();{N}");
            get.Append($"		}}{N}");
            get.Append($"		catch (Exception ex){{{N}");
            get.Append($"			throw ex;{N}");
